  ...
  return (
    <form className="flex flex-col gap-5 p-5 rounded-lg bg-gray-100 shadow-lg animate-fade-in animate-pulsate" onSubmit={onSubmit}>
      ...
      <label className="text-gray-700 text-sm font-bold flex-1">
        ...
        />
        {errors.password && (
          <span className="text-red-500 rounded-lg">{errors.password.message}</span>
        )}
      </label>
      <span className="flex items-center justify-between">
        ...
        <span className="mt-4 ml-4">
          <button
            type="submit"
            className="bg-red-500 text-white p-2 font-bold hover:bg-blue-500 text-xl animate-pulsate"
          >
            Login
          </button>
        </span>
